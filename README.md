...
Action
Signature with the word alert highlighted as the action.
...
Header
Header highlighted http $HOME_NET any - > $EXTERNAL_NET any
...
Rule options
Rule options highlighted which includes msg, flow, content, http_method, sid, and rev
